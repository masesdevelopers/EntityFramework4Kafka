...
/// </summary>
public class KafkaSqlTranslatingExpressionVisitor : ExpressionVisitor
{
    ...
    private static readonly MethodInfo ParameterValueExtractorMethod =
        typeof(KafkaSqlTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(ParameterValueExtractor));

    private static readonly MethodInfo ParameterListValueExtractorMethod =
        typeof(KafkaSqlTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(ParameterListValueExtractor));
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public KafkaSqlTranslatingExpressionVisitor(
