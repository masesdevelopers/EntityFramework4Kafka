...
{
    private abstract class KafkaProjectionBindingRemovingExpressionVisitorBase : ExpressionVisitor
    {
        ...
        private static readonly MethodInfo ToObjectWithSerializerMethodInfo
            = typeof(KafkaProjectionBindingRemovingExpressionVisitorBase)
                .GetRuntimeMethods().Single(mi => mi.Name == nameof(SafeToObjectWithSerializer));

        protected KafkaProjectionBindingRemovingExpressionVisitorBase(
...
#pragma warning restore EF1001 // Internal EF Core API usage.
        ...
        private static readonly MethodInfo IncludeReferenceMethodInfo
            = typeof(KafkaProjectionBindingRemovingExpressionVisitorBase).GetTypeInfo()
