...
/// </summary>
public class KafkaMethodCallTranslatorProvider : IMethodCallTranslatorProvider
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public KafkaMethodCallTranslatorProvider(
        ...
        IEnumerable<IMethodCallTranslatorPlugin> plugins)
    {
        ...
        _translators.AddRange(
            new IMethodCallTranslator[]
            {
                ...
                new KafkaStringMethodTranslator(sqlExpressionFactory),
