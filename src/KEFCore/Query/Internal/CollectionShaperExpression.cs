...
namespace MASES.EntityFrameworkCore.Query.Internal;
...
/// </summary>
public class _______________CollectionShaperExpression : Expression, IPrintableExpression
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public _______________CollectionShaperExpression(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual _______________CollectionShaperExpression Update(
        Expression projection,
        Expression innerShaper)
    {
        Check.NotNull(projection, nameof(projection));
        ...
        return projection != Projection || innerShaper != InnerShaper
            ? new _______________CollectionShaperExpression(projection, innerShaper, Navigation, ElementType)
            : this;
    }
