...
/// </summary>
public class KafkaMemberTranslatorProvider : IMemberTranslatorProvider
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public KafkaMemberTranslatorProvider(
        ...
        IEnumerable<IMemberTranslatorPlugin> plugins)
    {
        ...
        _translators
            .AddRange(
                ...
                {
                    new KafkaStringMemberTranslator(sqlExpressionFactory), new KafkaDateTimeMemberTranslator(sqlExpressionFactory)
                });
    }
