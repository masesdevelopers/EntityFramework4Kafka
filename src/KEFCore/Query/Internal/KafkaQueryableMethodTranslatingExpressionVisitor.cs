...
public class KafkaQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
{
    ...
    private readonly KafkaSqlTranslatingExpressionVisitor _sqlTranslator;
        ...
        : base(dependencies, queryCompilationContext, subquery: false)
    {
        ...
        _sqlTranslator = new KafkaSqlTranslatingExpressionVisitor(
            queryCompilationContext,
            _sqlExpressionFactory,
            _memberTranslatorProvider,
            _methodCallTranslatorProvider);
        _projectionBindingExpressionVisitor =
            new KafkaProjectionBindingExpressionVisitor(_queryCompilationContext.Model, _sqlTranslator);
    }
