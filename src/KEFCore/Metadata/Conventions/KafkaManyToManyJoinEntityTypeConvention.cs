...
/// </remarks>
public class KafkaManyToManyJoinEntityTypeConvention :
    ManyToManyJoinEntityTypeConvention,
    IEntityTypeAnnotationChangedConvention
{
    /// <summary>
    ///     Creates a new instance of <see cref="KafkaManyToManyJoinEntityTypeConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    public KafkaManyToManyJoinEntityTypeConvention(ProviderConventionSetBuilderDependencies dependencies)
        : base(dependencies)
    {
    }
    ...
    {
        if (name == KafkaAnnotationNames.PartitionKeyName
            || name == KafkaAnnotationNames.ContainerName)
        {
