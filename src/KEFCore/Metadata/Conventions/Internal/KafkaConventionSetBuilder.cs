...
namespace MASES.EntityFrameworkCore.Kafka.Metadata.Conventions.Internal;
...
public class KafkaConventionSetBuilder : ProviderConventionSetBuilder
{
    ...
    public override ConventionSet CreateConventionSet()
    {
        ...
        var discriminatorConvention = new KafkaDiscriminatorConvention(Dependencies);
        KeyDiscoveryConvention keyDiscoveryConvention = new KafkaKeyDiscoveryConvention(Dependencies);
        InversePropertyAttributeConvention inversePropertyAttributeConvention =
            new KafkaInversePropertyAttributeConvention(Dependencies);
        RelationshipDiscoveryConvention relationshipDiscoveryConvention =
            new KafkaRelationshipDiscoveryConvention(Dependencies);
        ...
        ValueGenerationConvention valueGenerationConvention = new KafkaValueGenerationConvention(Dependencies);
        ...
        ManyToManyJoinEntityTypeConvention manyToManyJoinEntityTypeConvention =
            new KafkaManyToManyJoinEntityTypeConvention(Dependencies);
        ...
        conventionSet.EntityTypeAnnotationChangedConventions.Add((KafkaValueGenerationConvention)valueGenerationConvention);
        conventionSet.EntityTypeAnnotationChangedConventions.Add((KafkaKeyDiscoveryConvention)keyDiscoveryConvention);
        conventionSet.EntityTypeAnnotationChangedConventions.Add(
            (KafkaManyToManyJoinEntityTypeConvention)manyToManyJoinEntityTypeConvention);
        ...
        ReplaceConvention(
            ...
            (RuntimeModelConvention)new KafkaRuntimeModelConvention(Dependencies));
