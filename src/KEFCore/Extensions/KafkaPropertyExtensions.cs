...
namespace MASES.EntityFrameworkCore.Kafka
{
    ...
    /// </remarks>
    public static class KafkaPropertyExtensions
    {
        /// <summary>
        ...
        public static string GetJsonPropertyName(this IReadOnlyProperty property)
            => (string?)property[KafkaAnnotationNames.PropertyName]
        ...
        public static ConfigurationSource? GetJsonPropertyNameConfigurationSource(this IConventionProperty property)
            => property.FindAnnotation(KafkaAnnotationNames.PropertyName)?.GetConfigurationSource();
    }
}
